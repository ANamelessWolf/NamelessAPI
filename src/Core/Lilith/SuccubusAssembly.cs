...
{
    /// <summary>
    /// This class maps the assembly file version
    /// </summary>
    ...
    public class SuccubusAssembly : NamelessObject
    {
        ...
        public string ShortVersion
        {
            get
            {
                return String.Format("{0}.{1}.{2}", this.Version.Major, this.Version.Minor, this.Version.Build);
            }
        }
        /// <summary>
        /// Initializes a new instance of the <see cref="SuccubusAssembly"/> class.
        /// </summary>
        /// <param name="type">A class type from the assembly.</param>
        public SuccubusAssembly(Type type)
            : this(System.Reflection.Assembly.GetAssembly(type).Location)
        {
        }
        /// <summary>
        /// Initializes a new instance of the <see cref="SuccubusAssembly"/> class.
        ...
        public static bool operator >(SuccubusAssembly ver1, SuccubusAssembly ver2)
        {
            if (ver1.Name != ver2.Name)
                throw new NamelessException(ERR_COMPARING_ASSEMBLY_VERSION);
