...
namespace Nameless.Libraries.Yggdrasil.Medaka
{
    ...
    public class ConfigMedaka : NamelessObject
    {
        ...
        /// <summary>
        /// Gets the xml application node from the configuration file.
        /// </summary>
        public readonly MedakaApplication App_Node;
        /// <summary>
        ...
        {
            ConfigCategory item = new ConfigCategory(catName, this.App_Node);
        ...
        private void FillCategory()
        {
            ...
            {
                cat = new ConfigCategory(catNode.Name.ToString(), this.App_Node);
                this.Add(cat);
            }
        }
        /// <summary>
